...
#
# Some Descriptions:
# First, I add the implementation of iaddq to this file
# iaddq V, rB
# Fetch: 
#		icode: ifun <- M1[PC]
#		rA: rB <- M1[PC + 1]
...
#		PC <- valP
#
# What we need to do is to set HCL expressions according to the 
# behaviour of iaddq instruction as provided above.
